...
const ItemList = ({items, navigation}) => {
  return (
   ...
   showsHorizontalScrollIndicator={false}
    renderItem={({ item })=>(
      <TouchableOpacity onPress={() => { navigation.navigate('ItemDetails',{item}); }} style={{marginBottom: 20, marginHorizontal: 20, marginEnd: 2, marginTop:10, backgroundColor: 'white', elevation: 10, height: 280, width: 180, borderRadius: 10}}>
          <Image style={{borderRadius: 10, width: 160, height: 160, justifyContent: 'center', alignSelf: 'center'}} source={{ uri: item.thumbnail }}/>
